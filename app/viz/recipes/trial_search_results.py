...
Renders as a `text/html` artifact — LibreChat mounts it in a Sandpack static
sandbox with Tailwind (Play CDN v3.4.17) preloaded, so utility classes work
out of the box.
